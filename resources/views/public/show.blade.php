        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('review') }}">
                    ...
                    {{-- titolo --}}
                    <div class="form-group row">
                        <label for="rv_title" class="col-md-4 col-form-label text-md-right">{{ __('Titolo') }}</label>
                    ...
                    <div id="user_id" class="form-group row">
                        <label for="user_id" class="col-md-4 col-form-label text-md-right">{{ __('Dottore') }}</label>
